...
export const ArtistProfileUpdateSchema = z.object({
    ...
    bioFull: z.string().max(5000).optional(),
    subGenres: z.array(z.string()).max(10).optional(),
    complementaryStyles: z.array(z.string()).max(10).optional(),
    roles: z.array(z.string()).max(10).optional(),
    professionalQuestions: z.any().optional(),
    status: z.string().optional(),
    mainGoal: z.string().optional(),
    availabilityStatus: z.string().optional(),
    opportunityTypes: z.array(z.string()).optional(),
    socialProofs: z.any().optional(),
    portfolioPdfUrl: z.string().url().optional().nullable(),
    portfolioPdfName: z.string().optional().nullable(),
...
export const CreateCollabPostSchema = z.object({
    ...
    mode: z.enum(['ONLINE', 'PRESENCIAL', 'HIBRIDO']).default('ONLINE'),
    ...
    publishedInFeed: z.boolean().default(true),
    publishedInStory: z.boolean().default(false),
});
