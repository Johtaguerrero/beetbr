        ...
        <div className="mx-auto max-w-4xl px-4 py-8 pb-32 lg:px-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-10">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Link href="/artist/seller/new" className="btn-accent text-[11px] px-8 py-3">+ NOVO ANÚNCIO</Link>
                </div>
            </div>
            ...
            {loading ? (
                    ...
                    {myLeads.length === 0 ? (
                        ...
                        myLeads.map((chat) => (
                            <div key={chat.id} className="beet-card p-5 flex items-center justify-between group">
                                ...
                                <Link href={`/artist/seller/chat/${chat.id}`} className="btn-accent px-6 py-2 text-[10px]">RESPONDER</Link>
                            </div>
                        ))
                    )}
                </div>
                ...
                <EmptyState icon="🛍️" title="Sua vitrine está vazia"
                    ...
                    action={<Link href="/artist/seller/new" className="btn-accent text-sm px-8">+ CRIAR MEU PRIMEIRO ANÚNCIO</Link>} />
            ) : filtered.length === 0 ? (
