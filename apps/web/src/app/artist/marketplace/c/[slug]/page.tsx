            ...
            <div className="mx-auto max-w-5xl px-4 py-6 pb-28 lg:px-6 lg:pb-6">
                ...
                <div className="mb-6">
                    <div className="flex items-center gap-2 text-beet-muted text-xs mb-2">
                        <Link href="/artist/marketplace" className="hover:text-[var(--color-primary-text,white)]">Marketplace</Link>
                        <span>›</span>
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        {loading ? (
                            ...
                            <div className="empty-state">
                                ...
                                <Link href="/artist/marketplace" className="btn-outline text-sm">Ver todos →</Link>
                            </div>
                        ) : (
